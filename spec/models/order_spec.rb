...
RSpec.describe Order, type: :model do
  ...
  it do
    is_expected.to define_enum_for(:status).with_values({ processing_order: 1, processing_error: 2, waiting_payment: 3, payment_accepted: 4, payment_denied: 5, finished: 6 })
  end
