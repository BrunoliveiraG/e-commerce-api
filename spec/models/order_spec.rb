...
RSpec.describe Order, type: :model do
  ...
  it do
    is_expected.to define_enum_for(:status).with_values({ processing_order: 1, processing_error: 2, waiting_payment: 3,
  ...
  it '#due_date must be 7 days ahead :created_at' do
    ...
    distance_days = (subject.due_date - subject.created_at) / 86_400
