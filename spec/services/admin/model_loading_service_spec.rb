  ...
  context 'when #call' do
    ...
    context 'when params are present' do
      let!(:search_system_requirements) do
        system_requirements = []
        15.times do |n|
          system_requirements << create(:system_requirement, name: "Search #{n + 1}", graphics_card: 'GeForce')
        end
        system_requirements
      end
      ...
      let(:params) do
        { search: { name: 'Search', graphics_card: 'GeFor' }, order: { name: :desc }, page: 2, length: 4 }
      end
